...
elif [ -f "myproject/production_settings.py" ]; then
    DJANGO_SETTINGS="myproject.production_settings"
else
    log "ERROR: Django settings file not found"
    exit 1
fi
